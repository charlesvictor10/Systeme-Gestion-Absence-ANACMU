...
public class Agent extends PersonnePhysique {
    ...
    public boolean estAdmin() {
        return (this.getFonction() != null && (this.getFonction().getCode().equals(ServiceEnum.DSI.toString())));
    }

    public boolean estRH() {
        return (this.getFonction() != null && (this.getFonction().getCode().equals(FonctionEnum.ResponsableRH.toString())) || this.getFonction().getCode().equals(FonctionEnum.DAF.toString()));
    }

    public boolean estDG() {
        return (this.getFonction() != null && (this.getFonction().getCode().equals(FonctionEnum.DirecteurGeneral.toString())) || this.getFonction().getCode().equals(FonctionEnum.SecretaireGeneral.toString()));
    }
