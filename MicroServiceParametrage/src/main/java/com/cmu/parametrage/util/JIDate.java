package com.cmu.parametrage.util;
...
public final class JIDate {
    ...
    // Formattage
    /////////////////////////////////////////////////////////////
    public static String formatDate(Date uneDate) {
        return FORMAT_DATE.format(uneDate);
    }

    public static String formatJsonDateHeure(Date uneDate) {
        return FORMAT_JSON_DATE_HEURE.format(uneDate);
    }

    public static String formatDateHeure(Date uneDate) {
        return FORMAT_DATE_HEURE.format(uneDate);
    }

    public static String formatDateHeureSeconde(Date uneDate) {
    ...
    public static Date dateSansHeure() {
        return dateSansHeure(now());
    }

    public static Date dateDuJourSansHeure() {
        return dateSansHeure(now());
    }

    // Récupération de Date
    /////////////////////////////////////////////////////////////
    public static Date dateSansHeure(Date aDate) {
    ...
    public static Date dateAvecHeure(Date aDate, Integer heure, Integer minute) {
        return dateAvecHeure(aDate, heure, minute, 0);
    }

    public static Date dateAvecHeure(Date aDate, Integer heure, Integer minute, Integer seconde) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(aDate);
