...
import com.cmu.parametrage.config.MailService;
import com.cmu.parametrage.dao.PasswordResetTokenRepository;
import com.cmu.parametrage.dao.RoleRepository;
import com.cmu.parametrage.dao.UtilisateurRepository;
import com.cmu.parametrage.entities.*;
import com.cmu.parametrage.payload.*;
import com.cmu.parametrage.security.TokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        addRoleToUser(result.getId(),RoleEnum.AG.getId());
    ...
    public ResponseEntity<?> updatePassword(@RequestBody Utilisateur utilisateur) {
        ...
        currentUser.setDateChangementMdp(JIDate.now());
        currentUser.setUpdateDate(JIDate.now());
    ...
    public ResponseEntity<?> forgotUserPassword(@Valid @RequestBody PasswordForgotRequest passwordForgotRequest) {
        ...
        if(existingUser != null) {
            ...
            mailMessage.setFrom("victor.wade@agencecmu.sn");
